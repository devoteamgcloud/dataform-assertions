 ...
 *   @property {Object} referentialIntegrityConditions - An object mapping parent table names to referential integrity conditions.
 */
...
const referential_integrity_assertions = require("./includes/referential_integrity_assertions"); // New import
...
module.exports = ({
    ...
    referentialIntegrityConditions = {} // New parameter
}) => {
    ...
    return {
        ...
        referentialIntegrityAssertions: referentialIntegrityAssertionsResult // New assertion
    };
}
